<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=F75C7E&center=true&vCenter=true&width=700&lines=Vibe+Coder+%26+Product-First+Builder+%F0%9F%92%A1;Aspiring+AI+Product+Manager+%F0%9F%A4%96;Building+AI-Powered+Solutions+%F0%9F%9A%80;Turning+Ideas+into+Useful+Products+%E2%9C%A8;Hackathon+Builder+%26+Problem+Solver+%F0%9F%A7%A9" alt="Typing SVG" />
  <br />

  ## 🌐 [Click here to view my Live Portfolio!](https://portfolio-audc.vercel.app/)
</div>

---

### 👩‍💻 About Me
- 💡 **Vibe coder & product-first builder** — I use AI tools to ship polished products fast, with a strong focus on user experience over just tech for tech's sake.
- 🤖 Passionate about building AI-first products and intelligent, useful experiences.
- 🎯 **Long-term goal:** transitioning from engineering into **AI Product Management**.
...
| :--- | :--- | :--- |
| **HemoLink** | Emergency blood coordination system with Dijkstra-based hospital routing, ABO/Rh compatibility engine, and FEFO inventory management. | [Repo](https://github.com/29-codeee/HemoLink) |
...
- 🤖 **AI Engineering Focus** — Exploring LLM integration, autonomous
